...
using DungeonDefinitionInitializer = MUnique.OpenMU.Persistence.Initialization.PlugIns.DungeonDefinitionInitializer;
using QuestNpcDefinitionInitializer = MUnique.OpenMU.Persistence.Initialization.PlugIns.QuestNpcDefinitionInitializer;
...
public class GameConfigurationInitializer : GameConfigurationInitializerBase
{
    ...
    public override void Initialize()
    {
        ...
        new DungeonDefinitionInitializer(this.Context, this.GameConfiguration).Initialize();
        new QuestNpcDefinitionInitializer(this.Context, this.GameConfiguration).Initialize();
    }

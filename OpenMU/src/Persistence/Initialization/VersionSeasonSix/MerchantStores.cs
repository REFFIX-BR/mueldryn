...
internal partial class NpcInitialization
{
    ...
    protected override ItemStorage CreatePotionGirlItemStorage(short number)
    {
        List<Item> itemList = new()
        {
            ...
            // Collections test: Bronze +11 Luck Opt4 Exc Reflect (Epic)
            this.CreateCollectionBronze(80, ItemGroups.Helm),
            this.CreateCollectionBronze(82, ItemGroups.Armor),
            this.CreateCollectionBronze(96, ItemGroups.Pants),
            this.CreateCollectionBronze(98, ItemGroups.Gloves),
            this.CreateCollectionBronze(112, ItemGroups.Boots),
        };
    ...
    protected override ItemStorage CreateWanderingMerchant(short number)
    {
        List<Item> itemList = new()
        {
            ...
            // Collections test: Bronze +11 Luck Opt4 Exc Reflect (Epic)
            this.CreateCollectionBronze(8, ItemGroups.Helm),
            this.CreateCollectionBronze(24, ItemGroups.Armor),
            this.CreateCollectionBronze(42, ItemGroups.Pants),
            this.CreateCollectionBronze(58, ItemGroups.Boots),
            this.CreateCollectionBronze(74, ItemGroups.Gloves),
        };
    ...
    protected override ItemStorage CreateLumenTheBarmaidStore(short number)
    {
        List<Item> itemList = new()
        {
            ...
            this.ItemHelper.CreateItem(66, 11, 14, 1, 8), // Box of Kundun +1
            this.ItemHelper.CreateItem(67, 11, 14, 1, 9), // Box of Kundun +2
            this.ItemHelper.CreateItem(68, 11, 14, 1, 10), // Box of Kundun +3
            this.ItemHelper.CreateItem(69, 11, 14, 1, 11), // Box of Kundun +4
            this.ItemHelper.CreateItem(70, 11, 14, 1, 12), // Box of Kundun +5
        };
    ...
    protected override ItemStorage CreateCarenTheBarmaidStore(short number)
    {
        List<Item> itemList = new()
        {
            ...
            this.ItemHelper.CreateItem(17, 11, 14, 1, 8), // Box of Kundun +1
            this.ItemHelper.CreateItem(18, 11, 14, 1, 9), // Box of Kundun +2
            this.ItemHelper.CreateItem(19, 11, 14, 1, 10), // Box of Kundun +3
            this.ItemHelper.CreateItem(20, 11, 14, 1, 11), // Box of Kundun +4
            this.ItemHelper.CreateItem(21, 11, 14, 1, 12), // Box of Kundun +5
        };
    ...
    private Item CreateCollectionBronze(byte slot, ItemGroups group)
    {
        var item = this.ItemHelper.CreateSetItem(slot, 0, group, Stats.DamageReflection, 11, 4, true);
        foreach (var link in item.ItemOptions.Where(o => o.ItemOption?.OptionType == ItemOptionTypes.Excellent))
        {
            link.Level = 3; // Epic -> Reflect +5%
        }

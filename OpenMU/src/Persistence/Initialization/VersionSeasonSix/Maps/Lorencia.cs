...
internal class Lorencia : Version095d.Maps.Lorencia
{
    ...
    protected override IEnumerable<MonsterSpawnArea> CreateNpcSpawns()
    {
        ...
        // Market Union Member Julia (547) intentionally omitted from Lorencia — removes the cart-side female NPC
        // next to the decorative carriage (~138,137). Julia remains available in Loren Market.
    }
}
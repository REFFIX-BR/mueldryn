...
public enum UpdateVersion
{
    ...
    /// <summary>
    /// The version of the <see cref="AddQuestPanelAttributesUpdatePlugIn"/>.
    /// </summary>
    AddQuestPanelAttributes = 103,

    /// <summary>
    /// The version of the <see cref="AddJewelBankAttributesUpdatePlugIn"/>.
    /// </summary>
    AddJewelBankAttributes = 104,

    /// <summary>
    /// The version of the <see cref="AddCityFiveMobSpotsUpdatePlugIn"/>.
    /// </summary>
    AddCityFiveMobSpots = 105,

    /// <summary>
    /// The version of the <see cref="EnableJewelInventoryStackingUpdatePlugIn"/>.
    /// </summary>
    EnableJewelInventoryStacking = 106,

    /// <summary>
    /// The version of the <see cref="AddCashShopItemsUpdatePlugIn"/>.
    /// </summary>
    AddCashShopItems = 107,

    /// <summary>
    /// The version of the <see cref="AddCashShopItemEffectsUpdatePlugIn"/>.
    /// </summary>
    AddCashShopItemEffects = 108,

    /// <summary>
    /// The version of the <see cref="AddTalismanOfLuckUpdatePlugIn"/>.
    /// </summary>
    AddTalismanOfLuck = 109,

    /// <summary>
    /// The version of the <see cref="AddCashShopRewardsUpdatePlugIn"/>.
    /// </summary>
    AddCashShopRewards = 110,

    /// <summary>
    /// The version of the <see cref="DisableSummonerAndRageFighterUpdatePlugIn"/>.
    /// </summary>
    DisableSummonerAndRageFighter = 111,

    /// <summary>
    /// The version of the <see cref="MakeShopBuffsDirectUpdatePlugIn"/>.
    /// </summary>
    MakeShopBuffsDirect = 112,

    /// <summary>
    /// The version of the <see cref="FixShopBuffIconsUpdatePlugIn"/>.
    /// </summary>
    FixShopBuffIcons = 113,

    /// <summary>
    /// The version of the <see cref="AddExtendedGoldenInvasionMobsUpdatePlugIn"/>.
    /// </summary>
    AddExtendedGoldenInvasionMobs = 114,

    /// <summary>
    /// The version of the <see cref="AddDungeonEntryAttributesUpdatePlugIn"/>.
    /// </summary>
    AddDungeonEntryAttributes = 115,

    /// <summary>
    /// The version of the <see cref="AddImperialFortressDungeonUpdatePlugIn"/>.
    /// </summary>
    AddImperialFortressDungeon = 116,

    /// <summary>
    /// The version of the <see cref="AddDungeonKeyCraftingsUpdatePlugIn"/>.
    /// </summary>
    AddDungeonKeyCraftings = 117,

    /// <summary>
    /// The version of the <see cref="AddColoredDungeonKeysUpdatePlugIn"/>.
    /// </summary>
    AddColoredDungeonKeys = 118,

    /// <summary>
    /// The version of the <see cref="AddDungeonNormalRewardsUpdatePlugIn"/>.
    /// </summary>
    AddDungeonNormalRewards = 119,

    /// <summary>
    /// The version of the <see cref="SetKundunBoxDropsUpdatePlugIn"/>.
    /// </summary>
    SetKundunBoxDrops = 120,

    /// <summary>
    /// The version of the <see cref="ExpandQuestPanelQuestsUpdatePlugIn"/>.
    /// </summary>
    ExpandQuestPanelQuests = 121,

    /// <summary>
    /// The version of the <see cref="AddSoulSystemAttributesUpdatePlugIn"/>.
    /// </summary>
    AddSoulSystemAttributes = 122,

    /// <summary>
    /// The version of the <see cref="AddCollectionBronzeShopUpdatePlugIn"/>.
    /// </summary>
    AddCollectionBronzeShop = 123,

    /// <summary>
    /// The version of the <see cref="FixCollectionBronzeShopUpdatePlugIn"/>.
    /// </summary>
    FixCollectionBronzeShop = 124,

    /// <summary>
    /// The version of the <see cref="AddPegasusCollectionAttributesUpdatePlugIn"/>.
    /// </summary>
    AddPegasusCollectionAttributes = 125,

    /// <summary>
    /// The version of the <see cref="AddQuestNpcUpdatePlugIn"/>.
    /// </summary>
    AddQuestNpc = 126,

    /// <summary>
    /// The version of the <see cref="AddQuestPanelAcceptedAttributeUpdatePlugIn"/>.
    /// </summary>
    AddQuestPanelAcceptedAttribute = 127,

    /// <summary>
    /// The version of the <see cref="AddQuestPanelStageAttributeUpdatePlugIn"/>.
    /// </summary>
    AddQuestPanelStageAttribute = 128,

    /// <summary>
    /// The version of the <see cref="AddQuestPanelPermanentPointsAttributeUpdatePlugIn"/>.
    /// </summary>
    AddQuestPanelPermanentPointsAttribute = 129,

    /// <summary>
    /// The version of the <see cref="FixSoulSystemAttributesUpdatePlugIn"/>.
    /// </summary>
    FixSoulSystemAttributes = 130,

    /// <summary>
    /// The version of the <see cref="FixPegasusCollectionAttributesUpdatePlugIn"/>.
    /// </summary>
    FixPegasusCollectionAttributes = 131,

    /// <summary>
    /// The version of the <see cref="RemoveLorenciaJuliaCarriageNpcUpdatePlugIn"/>.
    /// </summary>
    RemoveLorenciaJuliaCarriageNpc = 132,

    /// <summary>
    /// The version of the <see cref="EnableAllCharacterCreationUpdatePlugIn"/>.
    /// </summary>
    EnableAllCharacterCreation = 133,

    /// <summary>
    /// The version of the <see cref="EnableResetFeatureUpdatePlugIn"/>.
    /// </summary>
    EnableResetFeature = 134,

    /// <summary>
    /// The version of the <see cref="FarmSpotDensityUpdatePlugIn"/>.
    /// </summary>
    FarmSpotDensity = 135,

    /// <summary>
    /// The version of the <see cref="FixFarmSpotDensityUpdatePlugIn"/>.
    /// Re-applies farm density when 135 was marked installed without persisting side effects.
    /// </summary>
    FixFarmSpotDensity = 136,

    /// <summary>
    /// The version of the <see cref="AddMudreamCosmeticItemsUpdatePlugIn"/>.
    /// </summary>
    AddMudreamCosmeticItems = 137,

    /// <summary>
    /// The version of the <see cref="FixMudreamCosmeticSlotsUpdatePlugIn"/>.
    /// Corrects equipment slot + inventory size for Mudream cosmetics (group≠slot bug).
    /// </summary>
    FixMudreamCosmeticSlots = 138,

    /// <summary>
    /// The version of the <see cref="FixMudreamCosmeticClassRestrictionsUpdatePlugIn"/>.
    /// </summary>
    FixMudreamCosmeticClassRestrictions = 139,

    /// <summary>
    /// The version of the <see cref="FixMudreamCosmeticBowSlotUpdatePlugIn"/>.
    /// Moves cosmetic bows/crossbows to the left hand, where vanilla bows live.
    /// </summary>
    FixMudreamCosmeticBowSlot = 140,

    /// <summary>
    /// The version of the <see cref="FixMudreamCosmeticCrossbowSlotUpdatePlugIn"/>.
    /// Sends cosmetic crossbows back to the weapon hand; only bows belong in the shield slot.
    /// </summary>
    FixMudreamCosmeticCrossbowSlot = 141,

    /// <summary>
    /// The version of the <see cref="SpreadHuntMapFarmSpotsUpdatePlugIn"/>.

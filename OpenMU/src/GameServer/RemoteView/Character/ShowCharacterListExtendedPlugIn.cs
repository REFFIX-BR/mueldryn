...
public class ShowCharacterListExtendedPlugIn : IShowCharacterListPlugIn
{
    ...
    private static CharacterCreationUnlockFlags CreateUnlockFlags(Account account)
    {
        ...
        // This server always allows creating every Season 6 base class (MG/DL/Summoner/RF),
        // including on brand-new accounts that have never leveled up.
        result |= (byte)(CharacterCreationUnlockFlags.Summoner
            | CharacterCreationUnlockFlags.DarkLord
            | CharacterCreationUnlockFlags.MagicGladiator
            | CharacterCreationUnlockFlags.RageFighter);

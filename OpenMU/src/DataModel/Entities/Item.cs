...
public partial class Item
{
    ...
    /// <summary>
    /// Legacy flag (unused for name color). Kept for DB compatibility.
    /// Option rarity lives on <see cref="ItemOptionLink.Level"/> for excellent options.
    /// </summary>
    public bool IsRare { get; set; }

    /// <summary>
    /// Gets or sets Strength points granted by Excellent Bonus Options (Dream-style).
    /// </summary>
    public byte ExcellentBonusStrength { get; set; }

    /// <summary>
    /// Gets or sets Energy points granted by Excellent Bonus Options (Dream-style).
    /// </summary>
    public byte ExcellentBonusEnergy { get; set; }
    ...
    /// <summary>
    /// Gets or sets the UTC expiration timestamp for cash/period items.
    /// Null means the item does not expire.
    /// </summary>
    public DateTime? ExpirationDate { get; set; }

    /// <summary>
    /// Gets a value indicating whether this item has an expiration timestamp.
    /// </summary>
    public bool HasExpiration => this.ExpirationDate.HasValue;

    /// <summary>
    /// Gets a value indicating whether the item is past its expiration.
    /// </summary>
    public bool IsExpirationElapsed =>
        this.ExpirationDate is { } expire && expire <= DateTime.UtcNow;
    ...
    public void AssignValues(Item otherItem)
    {
        ...
        this.IsRare = otherItem.IsRare;
        this.ExcellentBonusStrength = otherItem.ExcellentBonusStrength;
        this.ExcellentBonusEnergy = otherItem.ExcellentBonusEnergy;
        this.SocketCount = otherItem.SocketCount;
        this.PetExperience = otherItem.PetExperience;
        this.ExpirationDate = otherItem.ExpirationDate;

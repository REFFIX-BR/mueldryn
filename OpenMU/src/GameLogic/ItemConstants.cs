...
public class ItemConstants
{
    ...
    /// <summary>
    /// Gets the identifier for the elite healing potion of the item shop.
    /// </summary>
    public static ItemIdentifier EliteHealingPotion => new(70, 14);

    /// <summary>
    /// Gets the identifier for the elite mana potion of the item shop.
    /// </summary>
    public static ItemIdentifier EliteManaPotion => new(71, 14);

    /// <summary>
    /// Gets the identifier for the elite shield potion of the item shop.
    /// </summary>
    public static ItemIdentifier EliteShieldPotion => new(133, 14);

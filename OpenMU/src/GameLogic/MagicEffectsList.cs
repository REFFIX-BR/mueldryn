...
{
    /// <summary>
    /// Effects with this number or higher are never sent to the game client, so they can be used
    /// for effects which the client does not know.
    /// </summary>
    public const byte InvisibleEffectStartIndex = 200;

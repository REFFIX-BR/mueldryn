...
public class Stats
{
    ...
    /// <summary>
    /// Gets the quest panel spider kill counter (custom side panel).
    /// </summary>
    public static AttributeDefinition QuestPanelSpiderKills { get; } = new(new Guid("7E4A91C2-3B5D-4F8A-9C1E-2D6B0A8F4E31"), "Quest Panel Spider Kills", "Kill progress for the side quest panel (Spider #3).");

    /// <summary>
    /// Gets the quest panel claimed flag (1 = reward already taken).
    /// </summary>
    public static AttributeDefinition QuestPanelClaimed { get; } = new(new Guid("8F5B02D3-4C6E-5A9B-0D2F-3E7C1B9A5F42"), "Quest Panel Claimed", "Whether the side quest panel reward was claimed.");

    /// <summary>
    /// Gets the quest panel accepted flag (1 = accepted from Quest Master NPC).
    /// </summary>
    public static AttributeDefinition QuestPanelAccepted { get; } = new(new Guid("D3A0F728-91B4-4C5E-8A6D-1F2E3B4C5D6E"), "Quest Panel Accepted", "Whether the side quest was accepted from the Quest Master NPC.");

    /// <summary>
    /// Gets the current main-quest stage index (0 = first quest). When >= catalog count, the chain is finished.
    /// </summary>
    public static AttributeDefinition QuestPanelStage { get; } = new(new Guid("E4B10839-A2C5-4D6F-9B7E-203142536475"), "Quest Panel Stage", "Current sequential main quest index.");

    /// <summary>
    /// Cumulative level-up points earned from main quests; added to every reset forever.
    /// </summary>
    public static AttributeDefinition QuestPanelPermanentPoints { get; } = new(new Guid("F5C2194A-B3D6-4E70-AC8F-314253647586"), "Quest Panel Permanent Points", "Permanent stat bonus from completed main quests (survives reset).");

    /// <summary>
    /// Gets the quest panel Bull Fighter kill counter.
    /// </summary>
    public static AttributeDefinition QuestPanelBullFighterKills { get; } = new(new Guid("9A6C13E4-5D7F-6B0C-1E3A-4F8D2C0B6A53"), "Quest Panel Bull Fighter Kills", "Kill progress for quest 1 (Bull Fighter #0).");

    /// <summary>
    /// Gets the quest panel Elite Yeti kill counter.
    /// </summary>
    public static AttributeDefinition QuestPanelEliteYetiKills { get; } = new(new Guid("A07D24F5-6E80-7C1D-2F4B-5A9E3D1C7B64"), "Quest Panel Elite Yeti Kills", "Kill progress for quest 2 (Elite Yeti #20).");

    /// <summary>
    /// Gets the quest 1 claimed flag (1 reset / spiders + bull fighters).
    /// </summary>
    public static AttributeDefinition QuestPanelQ1Claimed { get; } = new(new Guid("B18E3506-7F91-8D2E-305C-6B0F4E2D8C75"), "Quest Panel Q1 Claimed", "Whether quest 1 reward was claimed.");

    /// <summary>
    /// Gets the quest 2 claimed flag (5 resets / elite yetis).
    /// </summary>
    public static AttributeDefinition QuestPanelQ2Claimed { get; } = new(new Guid("C29F4617-80A2-9E3F-416D-7C105F3E9D86"), "Quest Panel Q2 Claimed", "Whether quest 2 reward was claimed.");

    /// <summary>
    /// Gets the Fortress of Imperial Dungeon last entry reset date (UTC, yyyyMMdd cast to float).
    /// </summary>
    public static AttributeDefinition DungeonEntryDateAttribute { get; } = new(new Guid("E5D4C3B2-A101-4F8E-9C7D-6B5A4F3E2D01"), "DungeonEntryDate", "Fortress of Imperial Dungeon — last entry reset date");

    /// <summary>
    /// Gets the Fortress of Imperial Dungeon entries consumed today (0–2, cast to float).
    /// </summary>
    public static AttributeDefinition DungeonEntriesConsumedAttribute { get; } = new(new Guid("E5D4C3B2-A102-4F8E-9C7D-6B5A4F3E2D02"), "DungeonEntriesConsumed", "Fortress of Imperial Dungeon — entries consumed today");

    /// <summary>UTC day number on which the Imperial Fortress daily counter was last reset.</summary>
    public static AttributeDefinition ImperialFortressEntryDay { get; } = new(new Guid("D41226B8-14E7-4EB8-940E-CE86BB4ABF01"), "Imperial Fortress Entry Day", "UTC day number of the Imperial Fortress daily entry counter.");

    /// <summary>Imperial Fortress entries consumed on the current UTC day.</summary>
    public static AttributeDefinition ImperialFortressDailyEntries { get; } = new(new Guid("D41226B8-14E7-4EB8-940E-CE86BB4ABF02"), "Imperial Fortress Daily Entries", "Number of Imperial Fortress entries consumed on the current UTC day.");

    /// <summary>Monotonic count of Imperial Fortress rewards granted to this character.</summary>
    public static AttributeDefinition ImperialFortressRewards { get; } = new(new Guid("D41226B8-14E7-4EB8-940E-CE86BB4ABF03"), "Imperial Fortress Rewards", "Monotonic reward grant counter used for auditing Imperial Fortress rewards.");

    /// <summary>Jewel Bank (account): Chaos count.</summary>
    public static AttributeDefinition JewelBankChaos { get; } = new(new Guid("A1B2C3D4-1001-4E5F-8A9B-0C1D2E3F4001"), "Jewel Bank Chaos", "Account-stored Jewel of Chaos count.");

    /// <summary>Jewel Bank (account): Bless count.</summary>
    public static AttributeDefinition JewelBankBless { get; } = new(new Guid("A1B2C3D4-1002-4E5F-8A9B-0C1D2E3F4002"), "Jewel Bank Bless", "Account-stored Jewel of Bless count.");

    /// <summary>Jewel Bank (account): Soul count.</summary>
    public static AttributeDefinition JewelBankSoul { get; } = new(new Guid("A1B2C3D4-1003-4E5F-8A9B-0C1D2E3F4003"), "Jewel Bank Soul", "Account-stored Jewel of Soul count.");

    /// <summary>Jewel Bank (account): Life count.</summary>
    public static AttributeDefinition JewelBankLife { get; } = new(new Guid("A1B2C3D4-1004-4E5F-8A9B-0C1D2E3F4004"), "Jewel Bank Life", "Account-stored Jewel of Life count.");

    /// <summary>Jewel Bank (account): Creation count.</summary>
    public static AttributeDefinition JewelBankCreation { get; } = new(new Guid("A1B2C3D4-1005-4E5F-8A9B-0C1D2E3F4005"), "Jewel Bank Creation", "Account-stored Jewel of Creation count.");

    /// <summary>Jewel Bank (account): Guardian count.</summary>
    public static AttributeDefinition JewelBankGuardian { get; } = new(new Guid("A1B2C3D4-1006-4E5F-8A9B-0C1D2E3F4006"), "Jewel Bank Guardian", "Account-stored Jewel of Guardian count.");

    /// <summary>Jewel Bank (account): Gemstone count.</summary>
    public static AttributeDefinition JewelBankGemstone { get; } = new(new Guid("A1B2C3D4-1007-4E5F-8A9B-0C1D2E3F4007"), "Jewel Bank Gemstone", "Account-stored Gemstone count.");

    /// <summary>Jewel Bank (account): Harmony count.</summary>
    public static AttributeDefinition JewelBankHarmony { get; } = new(new Guid("A1B2C3D4-1008-4E5F-8A9B-0C1D2E3F4008"), "Jewel Bank Harmony", "Account-stored Jewel of Harmony count.");

    /// <summary>Jewel Bank (account): Lower refining stone count.</summary>
    public static AttributeDefinition JewelBankLowStone { get; } = new(new Guid("A1B2C3D4-1009-4E5F-8A9B-0C1D2E3F4009"), "Jewel Bank Low Stone", "Account-stored Lower refining stone count.");

    /// <summary>Jewel Bank (account): Higher refining stone count.</summary>
    public static AttributeDefinition JewelBankHighStone { get; } = new(new Guid("A1B2C3D4-1010-4E5F-8A9B-0C1D2E3F4010"), "Jewel Bank High Stone", "Account-stored Higher refining stone count.");

    /// <summary>Soul System: remaining points to allocate.</summary>
    public static AttributeDefinition SoulPointsRemaining { get; } = new(new Guid("B1C2D3E4-2000-4F5A-9B0C-1D2E3F405060"), "Soul Points Remaining", "Unspent Soul System points.");

    // Alloc GUIDs match DB rows from update 122 ("Soul Element 0..15").
    // Note: elements 10..15 use decimal digits in the GUID tail (…010..015), not hex 0xA..0xF.
    public static AttributeDefinition SoulAlloc00 { get; } = new(new Guid("c0de5000-0000-4a01-8b50-000000000000"), "Soul Alloc Attack 0", "Soul System allocation Attack column 0.");
    public static AttributeDefinition SoulAlloc01 { get; } = new(new Guid("c0de5000-0000-4a01-8b50-000000000001"), "Soul Alloc Attack 1", "Soul System allocation Attack column 1.");
    public static AttributeDefinition SoulAlloc02 { get; } = new(new Guid("c0de5000-0000-4a01-8b50-000000000002"), "Soul Alloc Attack 2", "Soul System allocation Attack column 2.");
    public static AttributeDefinition SoulAlloc03 { get; } = new(new Guid("c0de5000-0000-4a01-8b50-000000000003"), "Soul Alloc Attack 3", "Soul System allocation Attack column 3.");
    public static AttributeDefinition SoulAlloc10 { get; } = new(new Guid("c0de5000-0000-4a01-8b50-000000000004"), "Soul Alloc Defense 0", "Soul System allocation Defense column 0.");
    public static AttributeDefinition SoulAlloc11 { get; } = new(new Guid("c0de5000-0000-4a01-8b50-000000000005"), "Soul Alloc Defense 1", "Soul System allocation Defense column 1.");
    public static AttributeDefinition SoulAlloc12 { get; } = new(new Guid("c0de5000-0000-4a01-8b50-000000000006"), "Soul Alloc Defense 2", "Soul System allocation Defense column 2.");
    public static AttributeDefinition SoulAlloc13 { get; } = new(new Guid("c0de5000-0000-4a01-8b50-000000000007"), "Soul Alloc Defense 3", "Soul System allocation Defense column 3.");
    public static AttributeDefinition SoulAlloc20 { get; } = new(new Guid("c0de5000-0000-4a01-8b50-000000000008"), "Soul Alloc Support 0", "Soul System allocation Support column 0.");
    public static AttributeDefinition SoulAlloc21 { get; } = new(new Guid("c0de5000-0000-4a01-8b50-000000000009"), "Soul Alloc Support 1", "Soul System allocation Support column 1.");
    public static AttributeDefinition SoulAlloc22 { get; } = new(new Guid("c0de5000-0000-4a01-8b50-000000000010"), "Soul Alloc Support 2", "Soul System allocation Support column 2.");
    public static AttributeDefinition SoulAlloc23 { get; } = new(new Guid("c0de5000-0000-4a01-8b50-000000000011"), "Soul Alloc Support 3", "Soul System allocation Support column 3.");
    public static AttributeDefinition SoulAlloc30 { get; } = new(new Guid("c0de5000-0000-4a01-8b50-000000000012"), "Soul Alloc Misc 0", "Soul System allocation Misc column 0.");
    public static AttributeDefinition SoulAlloc31 { get; } = new(new Guid("c0de5000-0000-4a01-8b50-000000000013"), "Soul Alloc Misc 1", "Soul System allocation Misc column 1.");
    public static AttributeDefinition SoulAlloc32 { get; } = new(new Guid("c0de5000-0000-4a01-8b50-000000000014"), "Soul Alloc Misc 2", "Soul System allocation Misc column 2.");
    public static AttributeDefinition SoulAlloc33 { get; } = new(new Guid("c0de5000-0000-4a01-8b50-000000000015"), "Soul Alloc Misc 3", "Soul System allocation Misc column 3.");

    /// <summary>VIP shop: expiration day number (days since Unix epoch) on the account.</summary>
    public static AttributeDefinition VipExpireDay { get; } = new(new Guid("C3D4E5F6-3001-4A7B-8C0D-2E3F40516011"), "VIP Expire Day", "Account VIP expiration as days since Unix epoch.");

    /// <summary>Cash Shop: WCoinC (Credit).</summary>
    public static AttributeDefinition WCoinC { get; } = new(new Guid("B2C3D4E5-2001-4F6A-9B0C-1D2E3F405001"), "WCoinC", "Cash shop WCoinC balance (account).");

    /// <summary>Cash Shop: WCoinP (Prepaid).</summary>
    public static AttributeDefinition WCoinP { get; } = new(new Guid("B2C3D4E5-2002-4F6A-9B0C-1D2E3F405002"), "WCoinP", "Cash shop WCoinP balance (account).");

    /// <summary>Cash Shop: Goblin Points.</summary>
    public static AttributeDefinition GoblinPoints { get; } = new(new Guid("B2C3D4E5-2003-4F6A-9B0C-1D2E3F405003"), "GoblinPoints", "Cash shop Goblin Points balance (account).");

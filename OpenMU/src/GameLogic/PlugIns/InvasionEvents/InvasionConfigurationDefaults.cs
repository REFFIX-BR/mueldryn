...
internal static class InvasionConfigurationDefaults
{
    ...
    public static PeriodicInvasionConfiguration Golden => new()
    {
        ...
        // Offset :30 so Golden does not collide with hour-aligned mini-games starts.
        Timetable = PeriodicTaskConfiguration.GenerateTimeSequence(TimeSpan.FromHours(4), new TimeOnly(0, 30)).ToList(),
        Mobs =
        [
            ...
            new(InvasionMonsters.GoldenDarkKnight, 10, [InvasionMaps.Dungeon], SpawnMapStrategy.RandomMap),
            new(InvasionMonsters.GoldenDevil, 10, [InvasionMaps.LostTower], SpawnMapStrategy.RandomMap),
            new(InvasionMonsters.GoldenStoneGolem, 10, [InvasionMaps.Aida], SpawnMapStrategy.RandomMap),
            new(InvasionMonsters.GoldenCrust, 10, [InvasionMaps.Icarus], SpawnMapStrategy.RandomMap),
            new(InvasionMonsters.GoldenSatyros, 10, [InvasionMaps.KanturuRuins], SpawnMapStrategy.RandomMap),
            new(InvasionMonsters.GoldenTwinTail, 10, [InvasionMaps.KanturuRelics], SpawnMapStrategy.RandomMap),
            new(InvasionMonsters.GoldenIronKnight, 5, [InvasionMaps.Raklion], SpawnMapStrategy.RandomMap),
            new(InvasionMonsters.GoldenNapin, 5, [InvasionMaps.SwampOfCalmness], SpawnMapStrategy.RandomMap),
            new(InvasionMonsters.GreatGoldenDragon, 3, [InvasionMaps.Raklion], SpawnMapStrategy.RandomMap, announceDeath: true),
            new(InvasionMonsters.GoldenRabbit, 20, [InvasionMaps.Elveland], SpawnMapStrategy.RandomMap),
        ],
    };
    ...
    public static PeriodicInvasionConfiguration RedDragon => new()
    {
        ...
        // Offset :00 of odd hours relative to Golden (:30) and White Wizard (:15).
        Timetable = PeriodicTaskConfiguration.GenerateTimeSequence(TimeSpan.FromHours(6), new TimeOnly(1, 0)).ToList(),
        Mobs =
        [
    ...
    public static PeriodicInvasionConfiguration WhiteWizard => new()
    {
        ...
        ForceSingleMap = true,
        Timetable = PeriodicTaskConfiguration.GenerateTimeSequence(TimeSpan.FromHours(2), new TimeOnly(0, 15)).ToList(),
        Mobs =
        [

...
Route::get("/achievements", function () {
    ...
    View::display("achievements/index", array("achievements" => $achievements));
...
Route::map("/achievements/add", function () {
    ...
    View::display("achievements/form", array("action" => "add", "achievement" => null));
...
Route::map("/achievements/edit/:id", function ($id) {
    ...
    View::display("achievements/form", array("action" => "edit", "achievement" => $achievement));
